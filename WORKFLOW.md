...
## 🧪 PHASE 4: POST-FLIGHT (The Epilogue)

11. **CALIBRATION & STACKING**
   -- Executed by: `core/postflight/calibration_engine.py`
   --- Reads : `/mnt/usb_buffer` raw subs.
   --- Generates: Master Stacked FITS.

12. **PHOTOMETRY EXTRACTION**
   -- Executed by: `core/postflight/photometry_engine.py`
   --- Reads : Master FITS + `data/sequences/*.json`
   --- Generates: Magnitude estimates + AAVSO report.
